...
class Scheduler(Task):
    def run(self):
        ...
        # Get hyperparameters from world
        ...
        selected_nodes = self.select_nodes(metrics, hyperparameters)
    ...
    def select_nodes(self, metrics: dict, hyperparameters: dict):
        """
        Select the nodes
        ...
        hyperparameters : dict
            The hyperparameters containing val_acc_threshold
        ...
        val_acc_threshold = hyperparameters.get("val_acc_threshold", 0.80)
